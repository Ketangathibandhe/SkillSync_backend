...
`;
  ...
  const data = await response.json();
  console.log("Gemini Skill Gap Response:", JSON.stringify(data, null, 2));
...
`;
  ...
  const data = await response.json();
  console.log("Gemini Roadmap Response:", JSON.stringify(data, null, 2));
...
// API 7: Update step status & progress
